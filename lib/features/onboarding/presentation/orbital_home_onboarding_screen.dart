...
class OrbitalHomeOnboardingScreen extends StatefulWidget {
  ...
  @override
  State<OrbitalHomeOnboardingScreen> createState() => _OrbitalHomeOnboardingScreenState();
}

class _OrbitalHomeOnboardingScreenState extends State<OrbitalHomeOnboardingScreen> with SingleTickerProviderStateMixin {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: TapScaleButton(
                        onTap: () => context.go('/ai-growth-onboarding'),
                        child: Container(
